...
celery.conf.update(
    ...
    task_routes={
        ...
        "app.scheduler.tasks.backfill_intelligence_events_task": {"queue": "default"},
...
celery.conf.beat_schedule = {
    ...
    "auto-verify-predictions-periodic": {
        ...
        "schedule": settings.auto_verification_interval_minutes * 60,
        "kwargs": {"batch_size": settings.auto_verification_batch_size},
        "options": {"queue": "prediction"},
    },
