...
export default function OnboardingPage() {
  ...
  const addSource = async () => {
    ...
    catch (reason) { setError(reason instanceof Error ? reason.message : "博主添加失败"); }
